package at.fhv.player.web;

import at.fhv.player.dto.ErrorResponseDTO;
import at.fhv.player.exception.BusinessRuleViolationException;
import at.fhv.player.exception.DomainException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleOptimisticLock(
        ...
        return build(HttpStatus.CONFLICT, "Player was modified concurrently – please retry", request);
    }
