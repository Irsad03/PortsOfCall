package at.fhv.session.web;

import at.fhv.session.dto.ErrorResponseDTO;
import at.fhv.session.exception.DomainException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleOptimisticLock(
        ...
        return build(HttpStatus.CONFLICT, "Session was modified concurrently – please retry", request);
    }
